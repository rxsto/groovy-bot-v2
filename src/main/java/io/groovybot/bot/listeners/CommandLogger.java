...
public class CommandLogger {
    ...
    private void onPermissionViolations(NoPermissionEvent noPermissionEvent) {
        ...
        EmbedBuilder builder = EmbedUtil.error(noPermissionEvent.translate("phrases.nopermission.title"), noPermissionEvent.translate(String.format("phrases.nopermission.%s.description", permission)));
