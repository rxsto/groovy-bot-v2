...
public class StatsCommand extends Command {
    ...
    public Result run(String[] args, CommandEvent event) {
        ...
        builder.addField(event.translate("command.stats.text.shards"), String.format("`%s` %s", event.getJDA().getShardInfo().getShardId() + 1, event.translate("phrases.text.shards")), true);
